...
var dutchbackendApp = angular.module('dutchbackendApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'dutchbackendAppUtils', 'pascalprecht.translate', 'truncate', 'ngCacheBuster']);
